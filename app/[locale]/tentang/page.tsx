  ...
  return (
    <>
      ...
      <section className="py-20 md:py-32 bg-mesh relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-0 w-40 h-40 md:w-80 md:h-80 bg-brand-violet/10 rounded-full blur-3xl" />
      ...
      <section className="py-20 md:py-32 bg-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-48 h-48 md:w-96 md:h-96 bg-brand-coral/5 rounded-full blur-3xl" />
