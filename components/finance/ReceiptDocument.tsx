      ...
      <div className="flex-1 flex flex-col m-[18px]">
        <div className="bg-white rounded-md flex-1 flex flex-col relative overflow-hidden">
          ...
          <div className="relative z-10 pl-8 pr-8 pt-7 pb-4">
            <div className="flex items-start justify-between mb-5">
              <div className="flex items-center gap-2.5">
                <SaikiLogoMark size={22} />
                <div className="h-4 w-[1px]" style={{ backgroundColor: `${brand.color}25` }} />
                <span className="text-[11px] font-bold tracking-[0.12em]" style={{ color: brand.color }}>{brand.label}</span>
              </div>
          ...
          <div className="relative z-10 pl-8 pr-8 pb-7 mt-auto">
            ...
            <div className="mt-4 px-0 py-2.5 flex items-center justify-between" style={{ borderTop: `1px solid ${brand.color}10` }}>
              <div className="flex items-center gap-2">
                <SaikiLogoMark size={11} />
