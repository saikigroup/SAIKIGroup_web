...
const typewriterWordsId = ['Bergerak.', 'Bertumbuh.', 'Berinovasi.', 'Sekarang.'];
const typewriterWordsEn = ['Move.', 'Grow.', 'Innovate.', 'Now.'];
...
export function HeroEditorial({
  ...
  const typewriterWords = locale === 'id' ? typewriterWordsId : typewriterWordsEn;

  return (
    <CursorGlow className="relative min-h-[90vh] flex items-center bg-mesh" color="rgba(13, 148, 136, 0.12)">
      {/* Particle field */}
          ...
          <div className="hidden lg:flex lg:col-span-5 items-center justify-center">
            ...
            >
              ...
              <motion.div
                ...
                className="relative w-72 h-72 glass rounded-3xl flex items-center justify-center shadow-2xl shadow-brand-teal/10 cursor-pointer"
              >
                <svg
                  viewBox="0 0 275 382"
                  fill="none"
