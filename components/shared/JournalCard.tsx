...
export function JournalCard({
  ...
  return (
    <Link href={`/${locale}/insights/${slug}`} className="block h-full">
      <motion.article
        whileHover={{ y: -8 }}
        transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
        className="group relative glass-strong rounded-2xl hover:shadow-xl hover:shadow-brand-teal/5 transition-all duration-300 h-full"
      >
