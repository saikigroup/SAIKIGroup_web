export const home = {
  hero: {
    eyebrow: 'SAIKI GROUP',
    headline: 'Move\nNow.',
    subheadline: 'Three business lines. One mission: helping individuals and organizations move with confidence in a world that never stops.',
  ...
  services: {
    eyebrow: 'Services',
    headline: 'Three Forces,\nOne Direction.',
    consultancy: {
      title: 'SAIKI Consultancy',
      description: 'Clear career direction. Strategic preparation. Real professional support to help you move forward.',
      tags: ['Career Consultancy', 'Professional Development', 'Job Readiness'],
    },
    imagery: {
      title: 'SAIKI Imagery',
      description: 'Meaningful branding. Impactful marketing. Visual identity and communication that builds connections.',
      tags: ['Branding', 'Marketing', 'Communication Strategy'],
    },
    technology: {
      title: 'SAIKI Technology',
      description: 'Software solutions built for real needs. From internal systems to production-ready digital platforms.',
      tags: ['Custom Software', 'White-Label', 'Business Systems'],
    },
  },
  why: {
    eyebrow: 'Approach',
  ...
  capabilities: {
    ...
    headline: 'Real Scenarios.',
    scenarios: [
      {
        context: 'You are a professional',
        need: 'who needs clearer career direction and a stronger personal positioning.',
        solution: 'SAIKI Consultancy helps you find the right position and prepare to claim it.',
      },
      {
